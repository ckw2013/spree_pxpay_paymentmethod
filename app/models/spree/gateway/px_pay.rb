...
private
    ...
    def px_pay_request(payment, callback_url)
      ...
      Pxpay::Request.new(payment.id, payment.amount, { :url_success => "/order-confirmation", :url_failure => "/order-unsuccessful", :currency_input => self.preferred_currency_input })
    end
